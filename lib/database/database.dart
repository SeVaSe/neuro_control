...
class AppDatabase {
  ...
  Future<void> _insertInitialReferenceGuides(Database db) async {
    ...
    final guides = [
      {
        'title': 'Укладка ребенка при рентгенографии ТБС',
        'content': '',
        'category': 'Общие сведения',
        'type': 'pdf',
        'pdf_path': "lib/assets/data/pdf/rentgen_spr.pdf",
        'is_pdf_loaded': 1,
        'created_at': now,
        'updated_at': now,
      },
      {
        ...
        'content': "Сиалорея (гиперсаливация, слюнотечение) — это патологическое состояние, характеризующееся чрезмерным образованием и/или выделением слюны из полости рта. В норме у взрослого человека за сутки выделяется около 1–1,5 литра слюны, которая выполняет важные функции — увлажняет слизистые оболочки, участвует в процессе жевания, глотания и начальном переваривании пищи, а также обладает антисептическими свойствами. При сиалорее количество выделяемой слюны значительно превышает физиологическую норму, либо нарушается её проглатывание, что приводит к непроизвольному подтеканию изо рта. Это состояние может наблюдаться при различных неврологических, стоматологических, гастроэнтерологических и отоларингологических заболеваниях. Чаще всего сиалорея развивается у пациентов с поражением центральной нервной системы, например, при детском церебральном параличе, болезни Паркинсона, бульбарных и псевдобульбарных синдромах, а также после инсультов или черепно-мозговых травм. В некоторых случаях гиперсаливация является побочным эффектом приёма лекарственных препаратов (например, антихолинэстеразных средств или некоторых антипсихотиков) или проявлением воспалительных процессов в полости рта и верхних дыхательных путях. Сиалорея приводит к значительному физическому и психологическому дискомфорту, может вызывать мацерацию кожи вокруг рта, развитие вторичных инфекций и трудности в общении. Диагностика направлена на установление причины гиперсаливации, а лечение включает коррекцию основного заболевания, физиотерапевтические методы, применение медикаментов, снижающих секрецию слюнных желез, а при необходимости — ботулинотерапию или хирургическое вмешательство.",
        'category': 'Общие сведения',
        'type': 'database',
        'pdf_path': null,
        'is_pdf_loaded': 0,
