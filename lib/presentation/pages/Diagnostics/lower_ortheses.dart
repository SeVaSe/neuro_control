...
class _LowerOrthosesPageState extends State<LowerOrthosesPage> {
  ...
  bool isLoading = true;
  String searchQuery = '';
  String timeFilter = 'Все'; // Все, Дневной, Ночной
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: ['Все', 'Дневной', 'Ночной'].map((filter) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Image container with time type badge
            Stack(
              children: [
                Container(
                  height: 180,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: orthosis.timeType == 'Ночной'
